import{Q as L,d as r,q as _,c as p,w as u,o as a,f as T,a as e,b as I,g as w,e as i,t as l,F as M,h as $,j as U,v as V}from"./app-DJ_ZTFbI.js";import{_ as G,a as F}from"./Update-DfReG9nS.js";import{_ as E}from"./Modal.vue_vue_type_style_index_0_scoped_fd08cd24_lang-B7C873nC.js";import{_ as B}from"./AdminPanel-DorjMUAR.js";import"./Modal-CKYSH-Ul.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./InputError-PkxbjC5q.js";import"./FormComponent-B6ZSceH5.js";import"./RetailGroup-ReiPV-Rs.js";import"./Logout-CqZ_wKbj.js";/* empty css                                                             */import"./RetailItems-BqM3fhIp.js";const j={class:"absolute adjust"},H={class:"flex justify-start items-center"},J={role:"tablist",class:"tabs tabs-lifted mt-10 p-5"},K={role:"tabpanel",class:"tab-content bg-base-200 border-base-300 p-6 h-[70vh] overflow-y-auto"},Y={class:"container mx-auto px-4"},z={class:"flex flex-wrap -mx-4"},q={key:0,class:"col-span-full text-center mt-8"},Q={key:1,class:"col-span-full text-center mt-8"},W={class:"text-red-600 text-lg"},X={key:2,class:"col-span-full text-center mt-8"},Z={class:"bg-blue-400 text-white text-center py-1"},tt={class:"w-full px-4 mb-8"},et={class:"flex bg-gray-200 font-semibold"},st={class:"w-1/4 p-2 text-center border-r border-gray-400"},ot={class:"divide-y divide-gray-300"},rt={class:"w-1/2 p-2 border-r border-gray-300"},at={class:"w-1/4 p-2 text-center border-r border-gray-300"},lt={class:"w-1/4 p-2 text-center"},dt=["onUpdate:modelValue","onInput"],nt={class:"flex bg-red-200"},it={class:"w-1/4 p-2 text-center border-r border-gray-300"},ct={class:"w-1/4 p-2 text-center"},bt={class:"max-w-md mx-auto border border-gray-300"},ut={class:"w-full"},pt={class:"border-b border-l border-gray-300 p-2 text-sm text-right"},gt={class:"border-l border-gray-300 p-2 text-sm text-right"},Dt={__name:"Index copy",setup(vt){const h=L(),d=r(h.props.picklist.map(s=>({...s,actual:s.COUNTED}))),N=r(""),C=r(""),D=r(""),g=r(!1),v=r(!1),R=r(!1),m=r(null),A=()=>{g.value=!1},S=()=>{v.value=!1},x=_(()=>d.value.reduce((s,t)=>s+parseFloat(t.COUNTED||0),0)),O=_(()=>d.value.reduce((s,t)=>s+parseFloat(t.actual||0),0)),n=()=>{const s=new Date;return`${s.getMonth()+1}/${s.getDate()}/${s.getFullYear().toString().substr(-2)}`},c=s=>{const t=parseFloat(s);return Number.isInteger(t)?t.toString():Math.round(t).toString()},k=s=>{if(s.actual!==""){const t=parseFloat(s.actual);s.actual=Math.round(t).toString()}},P=r(null),f=()=>{var b;const s=window.open("","","left=0,top=0,width=800,height=600,toolbar=0,scrollbars=0,status=0"),t=d.value.map(o=>`
    <tr>

import{C as Y,Q as nt,d as p,T as it,q as B,p as ct,c as R,w as m,o as n,f as K,a as e,b as g,g as A,j as S,s as bt,e as b,h as x,t as a,F as h,i as pt,v as z,u as T,n as ut}from"./app-CzESy9Lv.js";import{_ as gt,a as yt}from"./Update-D4Hq1fab.js";import{_ as E}from"./Modal.vue_vue_type_style_index_0_scoped_fd08cd24_lang-tx95LcV3.js";import{_ as vt}from"./TransparentButton-BaIZ_3qY.js";import{S as mt}from"./SearchColored-DsKTtPrb.js";import{B as _t}from"./Back-ZML3x6uz.js";import{_ as ft}from"./AdminPanel-CV7lwGts.js";import"./Modal-Cu8sf7v_.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./InputError-B0SuAqe_.js";import"./FormComponent-CsOP5KWL.js";import"./RetailGroup-CerRlS__.js";import"./Logout-D0Up-vhm.js";/* empty css                                                             */import"./RetailItems-BLW14K2q.js";import"./Attendance-BoQw81K6.js";const xt={class:"absolute adjust"},ht={class:"flex justify-start items-center"},Tt=["value"],Et=["value"],Ct={"date-rangepicker":"",class:"flex items-center"},It={class:"relative ml-5"},wt=["placeholder"],At={role:"tablist",class:"tabs tabs-lifted mt-10 p-5"},Nt={role:"tabpanel",class:"tab-content bg-base-200 border-base-300 p-6 h-[70vh] overflow-y-auto"},Dt={class:"container mx-auto px-4"},Ot={class:"flex flex-wrap -mx-4"},Rt={key:0,class:"col-span-full text-center mt-8"},St={key:1,class:"col-span-full text-center mt-8"},Lt={class:"text-red-600 text-lg"},kt={key:2,class:"col-span-full text-center mt-8"},Ut={class:"bg-blue-600 text-white text-center py-1 font-semibold"},Pt={class:"bg-blue-400 text-white text-center py-1"},$t={class:"w-full px-4 mb-8"},Mt={class:"flex bg-gray-200 font-semibold"},Gt={class:"w-1/4 p-2 text-center border-r border-gray-400"},Vt={class:"divide-y divide-gray-300"},jt={class:"w-1/2 p-2 border-r border-gray-300"},Ht={class:"w-1/4 p-2 text-center border-r border-gray-300"},Ft={class:"w-1/4 p-2 text-center"},Yt=["onUpdate:modelValue","onInput","disabled","title"],Bt={class:"flex bg-red-200"},Kt={class:"w-1/4 p-2 text-center border-r border-gray-300"},zt={class:"w-1/4 p-2 text-center"},Jt={class:"max-w-md mx-auto border border-gray-300"},qt={class:"w-full"},Wt={class:"border-b border-l border-gray-300 p-2 text-sm text-right"},Qt={class:"border-l border-gray-300 p-2 text-sm text-right"},Xt={role:"tabpanel",class:"tab-content bg-base-100 border-base-200 p-6 h-[85vh] overflow-y-auto"},Zt={key:0,class:"col-span-full text-center mt-8"},te={key:1,class:"col-span-full text-center mt-8"},ee={class:"text-red-600 text-lg"},re={key:2,class:"col-span-full text-center mt-8"},oe={class:"flex justify-between mb-4"},se={class:"w-full border-collapse border border-gray-300"},le={class:"border border-gray-300 p-2"},de={class:"border border-gray-300 p-2 text-center"},ae={class:"border border-gray-300 p-2 text-center"},ne={class:"border border-gray-300 p-2 text-right"},ie={class:"border border-gray-300 p-2 text-right"},ce={class:"bg-gray-200 font-bold"},be={class:"border border-gray-300 p-2 text-center"},pe={class:"border border-gray-300 p-2 text-center"},ue={class:"border border-gray-300 p-2 text-right"},ge={class:"border border-gray-300 p-2 text-right"},Se={__name:"Index copy 2",setup(ye){Y.defaults.headers.common["X-CSRF-TOKEN"]=document.querySelector('meta[name="csrf-token"]').getAttribute("content");const L=nt(),_=p(Object.entries(L.props.groupedPicklist).reduce((r,[t,s])=>(r[t]=s.map(o=>({...o,actual:o.ACTUAL})),r),{})),N=p(Object.entries(L.props.groupedPicklist).reduce((r,[t,s])=>(r[t]=s.map(o=>({...o,actual:o.ACTUAL})),r),{})),k=r=>new Date(r).toLocaleDateString(),y=r=>new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP"}).format(r),U=r=>r.reduce((t,s)=>t+Number(s.CHECKINGCOUNT||0),0),P=r=>r.reduce((t,s)=>t+Number(s.CHECKINGCOUNT||0),0),$=r=>r.reduce((t,s)=>t+Number(s.COST||0),0),M=r=>r.reduce((t,s)=>t+Number(s.COST||0)*Number(s.CHECKINGCOUNT||0),0),J=p(""),q=p(""),W=p(""),G=p(!1),V=p(!1),j=p(!1),C=p(null),v=it({StartDate:"2024-07-22",StoreName:"Urdaneta2"}),H=()=>{v.get(route("picklist.getrange"),{preserveScroll:!0})};p(null);const D=B(()=>{const r=v.StartDate;if(r){const t=new Date(r),s=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),d=String(t.getDate()).padStart(2,"0");return`${s}-${o}-${d}`}return""});p(null),B(()=>{const r=v.EndDate;if(r){const t=new Date(r),s=t.getFullYear(),o=String(t.getMonth()+1).padStart(2,"0"),d=String(t.getDate()).padStart(2,"0");return`${s}-${o}-${d}`}return""});const Q=()=>{G.value=!1},X=()=>{V.value=!1},Z=r=>r.reduce((t,s)=>t+parseFloat(s.COUNTED||0),0),I=(r,t)=>r.reduce((s,o)=>s+(o[t]||0),0),tt=r=>r.reduce((t,s)=>t+parseFloat(s.actual||0),0),u=()=>{const r=new Date;return`${r.getMonth()+1}/${r.getDate()}/${r.getFullYear().toString().substr(-2)}`},i=r=>{const t=parseFloat(r);return Number.isInteger(t)?t.toString():Math.round(t).toString()},et=async(r,t,s,o)=>{try{const l=_.value[r].find(f=>f.ITEMID===s);if(!l){console.error("Item not found");return}if(!l.JOURNALID){console.error("JOURNALID is missing for this item");return}const c=await Y.post("/api/update-actual",{journal_id:l.JOURNALID,store_name:r,item_name:t,item_id:s,actual:o});c.data.success?l.ACTUAL=o:console.error("Failed to update ACTUAL value",c.data)}catch(d){d.response&&d.response.data?(console.error("Server validation errors:",d.response.data.errors),Object.entries(d.response.data.errors).forEach(([l,c])=>{console.error(`${l}: ${c.join(", ")}`)})):console.error("Error updating ACTUAL value:",d.message)}},rt=p(null),ot=()=>{window.location.href="/picklist"},st=()=>{window.location.href="/mgcount"},lt=()=>{const r=window.open("","","left=0,top=0,width=800,height=600,toolbar=0,scrollbars=0,status=0"),t=Object.entries(_.value);let s="";for(let o=0;o<t.length;o+=2){const d=t.slice(o,o+2).map(([l,c])=>{const f=c.map(w=>`
  ...
  `),r.document.close(),r.focus(),r.print(),r.close()},dt=()=>{const r=window.open("","","left=0,top=0,width=800,height=600,toolbar=0,scrollbars=0,status=0"),t=Object.entries(_.value);let s="";for(let o=0;o<t.length;o+=2){const d=t.slice(o,o+2).map(([l,c])=>{const f=c.map(F=>`
        <tr>

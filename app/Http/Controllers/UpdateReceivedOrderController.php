...
class UpdateReceivedOrderController extends Controller
{
    public function index(Request $request)
    {
        try {
            ...
            return Inertia::render('Reports/ReceivedOrdersConso2', ['orders' => $orders]);
    ...
    public function receivedorderconsogetrange(Request $request)
    {
        try {
            $request->validate([
                'StartDate' => 'required|date',
            ...
            return Inertia::render('Reports/ReceivedOrdersConso2', ['orders' => $orders, 'startDate' => $startDate, 'endDate' => $endDate]);
    ...
    public function receivedwarehousegetrange(Request $request)
    {
        try {
            $request->validate([
                'StartDate' => 'required|date',
    ...
    public function show(Request $request)
    {
        ...
        return Inertia::render('Reports/ReceivedOrdersConso2');
    }
    ...
    public function lastmonth(Request $request)
    {
        try {
            ...
            return Inertia::render('Reports/ReceivedOrdersConso2', ['orders' => $orders, 'startDate' => $formattedStartDate, 'endDate' => $formattedEndDate]);
    ...
    public function yesterday(Request $request)
    {
        try {
            ...
            return Inertia::render('Reports/ReceivedOrdersConso2', ['orders' => $orders, 'startDate' => $formattedYesterday, 'endDate' => $formattedYesterday]);

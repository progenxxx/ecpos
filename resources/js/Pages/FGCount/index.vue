<script setup>
import Create from "@/Components/FGCount/Create.vue";
import GetBWP from "@/Components/FGCount/GetBWP.vue";
import Post from "@/Components/FGCount/Post.vue";
import CopyFrom from "@/Components/FGCount/CopyFrom.vue";
...
const deleteorders = () => {
    const userConfirmed = window.confirm('Are you sure you want to delete all orders?');
...
const postorders = () => {
    const userConfirmed = window.confirm('Are you sure you want to post all orders?');
        ...
        <div class="absolute adjust" :class="{ 'mt-20': message.text }">
            <div class="flex justify-start items-center">
                ...
                <PrimaryButton
                    ...
                    class="m-1 ml-2 bg-green-900 p-10"
                >
                    <Save class="h-5" />
                </PrimaryButton>
                <PrimaryButton
                ...
                <PrimaryButton
                    type="button"
                    @click="toggleGetCFModal"
                    class="m-2 sm:m-6 bg-red-900"
                  >
                  POST
                  </PrimaryButton>

...
import Postbatch from "@/Components/Svgs/postbatch.vue";
...
const updateAllCountedValues = async () => {
    try {
        ...
        const response = await axios.post('/stock-counting-line/update-all-counted-values', {
...
const initializeDataTable = () => {
    ...
    try {
        const dtInstance = dataTableRef.value.dt;
        if (dtInstance) {
            window.dataTableInstance = dtInstance;

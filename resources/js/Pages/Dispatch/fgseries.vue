...
import Create from "@/Components/Dispatch/Create.vue";
import Update from "@/Components/Dispatch/Update.vue";
            ...
            <TableContainer>
                ...
                <div class="absolute adjust">
                    <div class="flex justify-start items-center">
                        ...
                        <!-- <PrimaryButton
                                class="ml-5 cursor-pointer bg-navy"
                ...
                <DataTable :data="inventjournaltables" :columns="columns" class="w-full relative display" :options="options" >
                    <template #action="data">
                        ...
                        <div class="flex justify-start">
                                ...
                                @click="navigateItem(data.cellData.journalid)"
                                >
                                <!-- <moreblue class="h-6 mr-10"></moreblue> -->
                                 ITEMS
                                </PrimaryButton>

    ...
    <Main active-tab="HOME" prop-class="p-1">
        <template v-slot:main>
            ...
            <carousel :settings="carouselSettings" :breakpoints="breakpoints" class="mt-2 w-full pl-5 justify-center">
                ...
                <slide v-for="window in windowtables" :key="window.id" :value="window.DESCRIPTION">
                    <carousel-slides :show-this="showThis === window.DESCRIPTION" @click="showTab(window.DESCRIPTION, window.DESCRIPTION)">
                    {{ window.DESCRIPTION }}
                    </carousel-slides>
                </slide>
            ...
            <section class="mt-5">
                ...
                <div class="mt-2 grid grid-cols-12 gap-2">
                    <div v-for="window123 in windowtrans" :key="window123.id" :value="window123.DESCRIPTION">

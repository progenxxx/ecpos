...
<div class="flex flex-col min-h-screen">
  <!-- Sticky header -->
  <header class="sticky top-0 bg-white shadow-md z-10 mb-5">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      <h1 class="text-sm font-bold">ECORDER</h1>
      <!-- <nav>
        <ul class="flex space-x-4">
          <li><a href="#" class="text-blue-600 hover:text-blue-800">Menu 1</a></li>
          <li><a href="#" class="text-blue-600 hover:text-blue-800">Menu 2</a></li>
          <li><a href="#" class="text-blue-600 hover:text-blue-800">Menu 3</a></li>
        </ul>
      </nav> -->
    </div>
  </header>
  ...
  <nav class="fixed bottom-0 left-0 right-0 bg-navy shadow-lg">
    <div class="flex justify-around items-center h-16 relative">
      ...
      <button href="m-createorders" class="absolute left-1/2 top-0 transform -translate-x-1/2 -translate-y-1/2 w-14 h-14 bg-blue-700 rounded-full shadow-lg flex items-center justify-center border-2 border-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
      ...
      <a href="/m-orders" class="flex flex-col items-center text-white">
        <Cart class="w-5"></Cart>
        <span class="text-xs mt-1">MyOrders</span>
      </a>
    </div>
  </nav>
</div>

...
const submitForm = () => {
form.get(route('picklist.getstore'), {
  preserveScroll: true,
});
};
    ...
    const pageContent = stores.slice(i, i + 2).map(([storeName, storeItems]) => {
      ...
      return `
        <div class="store-section">
          ...
          <div class="bg-blue-400">DELIVERY DATE: ${formatDate(storeItems[0]?.DELIVERYDATE)}</div>
          <table>
            <thead>
              <tr>
          ...
          <table style="margin-top: 5px;">
            <tbody>
              <tr>
                ...
                <td style="width: 60%;">
                  <div>${storeItems[0]?.DISPATCHER}</div>
                  <div class="signature-line"></div>
                </td>
                <td class="text-right" style="width: 20%;">${formatDate(storeItems[0]?.DELIVERYDATE)}</td>
              </tr>
              <tr>
                <td class="font-semibold" style="width: 20%;">LOGISTICS:</td>
                <td style="width: 60%;">
                  <div>${storeItems[0]?.LOGISTICS}</div>
                  <div class="signature-line"></div>
                </td>
                <td class="text-right" style="width: 20%;">${formatDate(storeItems[0]?.DELIVERYDATE)}</td>
              </tr>
      ...
      <div class="receipt-page">
        ...
        <div class="mt-8 flex justify-between">
          <div>
            ...
            <p>${storeData[0].DISPATCHER} | ${formatDate(storeData[0].DELIVERYDATE)}</p>
  ...
  <Main active-tab="FGCOUNT">
    ...
    <template v-slot:main>
          ...
          >
            ...
            <details className="dropdown">
                ...
                <ul className="menu dropdown-content !bg-gray-100 rounded-box z-[1] w-52 p-2 shadow">
                  <li><a href="/picklist">ALL</a></li>
                  <li><a href="/pl-south1">SOUTH 1</a></li>
                  <li><a href="/pl-south2">SOUTH 2</a></li>
                  <li><a href="/pl-south3">SOUTH 3</a></li>
                  <li><a href="/pl-north1">NORTH 1</a></li>
                  <li><a href="/pl-north2">NORTH 2</a></li>
                  <li><a href="/pl-central">CENTRAL</a></li>
                  <li><a href="/pl-east">EAST</a></li>
                </ul>
            </details>
      ...
      <div role="tablist" class="tabs tabs-lifted mt-10 p-5">
        <input type="radio" name="my_tabs_2" role="tab" class="tab !bg-gray-200 !border-gray-300 !text-gray-500 !font-bold" aria-label="PICK LIST" checked />
        <div role="tabpanel" class="tab-content !bg-gray-200 !border-gray-300 p-6 h-[70vh] overflow-y-auto">
                      ...
                      <table class="w-full">
                        <tr>
                          ...
                          <td class="border-b border-gray-300 p-2">
                            ...
                            <div>{{ storeItems[0]?.DISPATCHER || 'Not available' }}</div>
                            <div class="border-b border-gray-300 mt-4"></div>
                          </td>
                          <td class="border-b border-l border-gray-300 p-2 text-sm text-right">{{ formatDate(storeItems[0]?.DELIVERYDATE) || 'Not available' }}</td>
                        </tr>
                        <tr>
                          <td class="border-r border-gray-300 p-2 font-semibold">LOGISTICS:</td>
                          <td class="p-2">
                            <!-- <div>SIGN OVER PRINTED NAME</div> -->
                            <div>{{ storeItems[0]?.LOGISTICS || 'Not available' }}</div>
                            <div class="border-b border-gray-300 mt-4"></div>
                          </td>
                          <td class="border-l border-gray-300 p-2 text-sm text-right">{{ formatDate(storeItems[0]?.DELIVERYDATE) || 'Not available' }}</td>
                        </tr>
                      </table>
                    </div>
                    <br>

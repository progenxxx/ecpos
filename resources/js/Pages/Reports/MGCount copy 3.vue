...
.custom-datatable .dataTables_scrollBody td:nth-child(2) { left: 100px; background-color: white;}

.custom-datatable .dataTables_scrollHead th:nth-child(3),
.custom-datatable .dataTables_scrollBody td:nth-child(3) { left: 200px; background-color: white;}

.custom-datatable .dataTables_scrollHead th:nth-child(4),
.custom-datatable .dataTables_scrollBody td:nth-child(4) { left: 300px; background-color: white;}

.custom-datatable .dataTables_scrollHead th:nth-child(5),
.custom-datatable .dataTables_scrollBody td:nth-child(5) { left: 400px; background-color: white;}

...
<template>
  <div v-if="showMessage" class="fixed top-5 right-5 bg-navy text-white border border-gray-300 rounded-lg shadow-lg p-4 z-50">
    {{ messageText }}
  </div>
...
.custom-datatable .dataTables_scrollBody td:nth-child(1) { left: 0; }

.custom-datatable .dataTables_scrollHead th:nth-child(2),
.custom-datatable .dataTables_scrollBody td:nth-child(2) { left: max(5%, 10px); }

.custom-datatable .dataTables_scrollHead th:nth-child(3),
.custom-datatable .dataTables_scrollBody td:nth-child(3) { left: max(10%, 20px); }

.custom-datatable .dataTables_scrollHead th:nth-child(4),
.custom-datatable .dataTables_scrollBody td:nth-child(4) { left: max(15%, 30px); }

.custom-datatable .dataTables_scrollHead th:nth-child(5),
.custom-datatable .dataTables_scrollBody td:nth-child(5) { left: max(20%, 40px); }

.custom-datatable .dataTables_scrollHead th:nth-child(6),
.custom-datatable .dataTables_scrollBody td:nth-child(6) { left: max(25%, 50px); }

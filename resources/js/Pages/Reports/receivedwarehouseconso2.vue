...
const submitForm = () => {
  form.get(route('receivedwarehouse.getrange'), {
  preserveScroll: true,
});
};
const toggleActive = () => {
...
const SYNCFG = () => {
    const userConfirmed = window.confirm('Sync Current Stocks');
      ...
      <div class="absolute adjust">
        ...
        <div class="flex justify-start items-center">
          ...
          <details className="dropdown">
            ...
            <ul className="menu dropdown-content !bg-gray-100 rounded-box z-[1] w-52 p-2 shadow">
              <li><a href="/received-lastmonth">Last Month</a></li>
              <li><a href="/received-lastweek">Last Week</a></li>
              <li><a href="/received-yesterday">Yesterday</a></li>
            </ul>
          </details>

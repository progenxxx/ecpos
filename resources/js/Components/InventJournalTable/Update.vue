...
const submitForm = () => {
    form.patch("/inventjournaltables/patch", {
        preserveScroll: true,
    });
};
...
onMounted(() => {
    ...
    watch(() => props.JOURNALTYPE, (newValue) => {
        form.JOURNALTYPE = newValue;
    });
    watch(() => props.DELETEPOSTEDLINES, (newValue) => {
        form.DELETEPOSTEDLINES = newValue;
    });

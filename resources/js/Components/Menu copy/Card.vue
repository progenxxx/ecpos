<template>
    <span class="relative flex flex-col justify-center w-3/12 min-h-20 bg-white shadow-md shadow-gray-200 py-4 px-2 rounded-lg cursor-pointer lg:w-2/12">
        <span class="font-bold text-base text-nowrap overflow-hidden">
            <figure><img src="../../../../../pos-tailwind/public/images/Product.webp" alt="Coffee" /></figure>
        </span>

...
const submitPartialPayment = async () => {
  try {
    ...
    console.log(`Submitting partial payment of ${partialPaymentAmount.value}`);
    ...
    if (paymentResponse.data.success) {
      ...
      // Optionally, you can reload the page or update the cart data here
      // For example:
      // await fetchCartData(); // Implement this function to refresh cart data
      // or
      location.reload();
    } else {
...
const submitRemovePartialPayment = async () => {
  try {
    isLoading.value = true;
    console.log(`Removing partial payment of ${removePartialPaymentAmount.value}`);
